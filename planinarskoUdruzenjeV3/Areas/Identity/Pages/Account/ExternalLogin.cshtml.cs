    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            public string FirstName
            {
                get
                {
                    return this.FullName != null && this.FullName.Split(' ').First() != null ? this.FullName.Split(' ').First() : "";
                }
            ...
            public string LastName
            {
                get
                {
                    return this.FullName != null && this.FullName.Split(' ').Last() != null ? this.FullName.Split(' ').Last() : "";
                }
            }
        }
